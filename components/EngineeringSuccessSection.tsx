...
function SuccessDonutChart({
  ...
  return (
    <div className="relative mx-auto w-full max-w-md">
      <svg viewBox="0 0 440 460" className="h-auto w-full" aria-hidden>
        <defs>
...
export function EngineeringSuccessSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 md:grid-cols-2 lg:grid-cols-[1fr_1.05fr] lg:gap-16 lg:px-8">
        {/* Donut Chart */}
        <motion.div
